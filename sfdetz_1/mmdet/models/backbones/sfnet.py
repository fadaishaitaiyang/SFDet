...
class CoordAtt(nn.Module):
    ...
    def forward(self, x):
        ...
        x_h, x_w = torch.split(scale, [h, w], dim=2)
...
class Bottleneck_1(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.bn3(out)
        # thres = self.ca(out)
        # out = torch.sign(out) * (torch.abs(out)-thres)
...
class SFNet(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(SFNet, self).__init__(init_cfg)
